        ...
        <form action="{{ route('faculty.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="name" name="name" placeholder="e.g. Dr. Jane Doe" type="text" value="{{ old('name') }}" required/>
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="email" name="email" placeholder="jane@university.edu" type="email" value="{{ old('email') }}" required/>
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="employee_id" name="employee_id" placeholder="EMP-0001" type="text" value="{{ old('employee_id') }}" required/>
