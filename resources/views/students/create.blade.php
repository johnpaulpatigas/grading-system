    ...
    <div class="p-8">
        <div class="flex items-center space-x-4 mb-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500">Enter official details and account information.</p>
            </div>
        </div>
        ...
        <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="email" name="email" placeholder="jane@example.com" type="email" value="{{ old('email') }}" required/>
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="course" name="course" placeholder="e.g. BS Computer Science" type="text" value="{{ old('course') }}" required/>
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="section" name="section" placeholder="e.g. A-1" type="text" value="{{ old('section') }}" required/>
