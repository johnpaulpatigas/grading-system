...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        <h2 class="text-3xl font-bold text-gray-900">Add Student Record</h2>
            ...
            <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        <input class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-sm" id="student_id" name="student_id" maxlength="8" placeholder="20230753" type="text" value="{{ old('student_id') }}" required/>
                    </div>
