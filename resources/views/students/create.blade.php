            ...
            <form action="{{ route('students.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="student_id" name="student_id" maxlength="8" placeholder="20230753" type="text" value="{{ old('student_id') }}" required/>
