...
<input class="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 text-gray-900 transition-all" id="email" name="email" placeholder="admin@cpc.edu" type="email" required autofocus/>
</div>
@error('email')
...
<div class="mt-6 text-center">
    <p class="text-sm text-gray-500">Don't have an account? <a href="{{ route('register') }}" class="text-blue-600 font-semibold hover:underline">Sign up as Student</a></p>
</div>
