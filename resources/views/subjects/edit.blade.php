...
<nav class="flex items-center space-x-2 text-sm text-gray-500 mb-6">
    ...
    <span>›</span>
    <span class="font-medium text-gray-800">Edit Subject</span>
</nav>

<div class="mb-10">
    <h2 class="text-3xl font-bold text-gray-900 mb-1">Edit Academic Subject</h2>
    <p class="text-gray-500">Update subject details for the curriculum database.</p>
</div>
        ...
        <form action="{{ route('subjects.update', $subject) }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-4">
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="subject_code" name="subject_code" placeholder="e.g. CS-402" type="text" value="{{ old('subject_code', $subject->subject_code) }}" required/>
                ...
                <div class="space-y-1.5">
                    ...
                    <input class="w-full px-4 py-3 rounded-lg border-gray-200 focus:border-blue-500 focus:ring-blue-500 text-sm" id="description" name="description" placeholder="e.g. Advanced Algorithms" type="text" value="{{ old('description', $subject->description) }}" required/>
